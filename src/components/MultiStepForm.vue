...
export default {
  data: () => {
    return {
      ...
      formSteps: [
        {
          title: "porra anime wolksvagen",
          fields: [
            { label: "Hmm sasuke?", value: '', valid: true, pattern: /.+/ },
            { label: "Hmm naruto?", value: '', valid: true, pattern: /.+/ },
            { label: "Hmm sauka?", value: '', valid: true, pattern: /.+/ },
          ]
        },
        {
          title: "porra anime wolksvagen",
...
.animate-wrong {
  animation: wrong .6s ease-in-out;
}
